...
| 四月 |        <a href="#954-二倍数对数组">954</a>        |                                       |                                                        |                                                       | <a href="#307-区域和检索---数组可修改">307</a> |                                                              |                                                              |                                                              |                                         |                                                              |                                               |                                              |                                                              |                                                              |                                                           |                                           |                                                 |                                               |                                                              |                                                              |                                               |                                                              |                                                              |                                                 |                                   |                                                 |                                             |                                                   |                                                              |                                                              |                                                  |
...
| 2022.04.03 |                             未做                             |            |                                                              |
| 2022.04.04 |                             未做                             |            |                                                              |
| 2022.04.05 | <a href="#307-区域和检索---数组可修改">307-区域和检索 - 数组可修改</a> |    中等    | 几天没做题了，生疏了太多太多了。今天这道题尝试了两种想法，最终都以超时告终。而官解的三种解法才只看了一种（分块），另外的两种解法（线段树和树状数组）还不大会，又得拖到后续再来学习了。 |
...
| [307. 区域和检索 - 数组可修改](https://leetcode-cn.com/problems/range-sum-query-mutable/) | 实现类 | 分块处理、线段树、树状数组 | 中等 | 2022.04.05 | 2022.04.05 | 1 | 否 | 否 | 否 | B | <a href="#307-区域和检索---数组可修改">307</a> |
