...
| 2021.11.26 |        <a href="#518-零钱兑换 II">518-零钱兑换 II</a>        | 刚开始用类似于上一题的思路去解决此问题，只需要修改部分即可，但是得到结果后发现这样会造成计算重复，和官方答案一比较，发现就是内外层循环位置的问题 |
...
|     动态规划     |                                   | <a href="#42-接雨水">42</a>、<a href="#198-打家劫舍">198</a>、<a href="#213-打家劫舍 II">213</a>、<a href="#300-最长递增子序列">300</a>、<a href="#322-零钱兑换">322</a>、<a href="#518-零钱兑换 II">518</a>、<a href="#673-最长递增子序列的个数">673</a>、<a href="#740-删除并获得点数">740</a>、<a href="#746-使用最小花费爬楼梯">746</a> | <a href="#62-不同路径">62</a>、<a href="#980-不同路径 III">980</a>、<a href="#494-目标和">494</a>、<a href="#1444-切披萨的方案数">1444</a> |                                         |                                                              |                                                              | <a href="#337-打家劫舍 III">337</a> |      | <a href="#70-爬楼梯">70</a>、<a href="#509-斐波那契数">509</a>、<a href="#1137-第 N 个泰波那契数">1137</a> |
...
| [518. 零钱兑换 II](https://leetcode-cn.com/problems/coin-change-2/) | 数组 | 动态规划 | 中等 | 2021.11.26 | 2021.11.26 | 1 | 否 | 否 | 是 | B | <a href="#518-零钱兑换 II">518</a> |
