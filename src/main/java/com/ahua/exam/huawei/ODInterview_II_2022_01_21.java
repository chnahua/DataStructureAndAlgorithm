...
public class ODInterview_II_2022_01_21 {
    public static void main(String[] args) {
        ...
        ODInterview_II_2022_01_21_Solution solution = new ODInterview_II_2022_01_21_Solution();
 ...
 */
// 现场面试版本
class ODInterview_II_2022_01_21_Solution1 {
...
// 添加注释版本
class ODInterview_II_2022_01_21_Solution2 {
    public String func(int[] nums1, int[] nums2) {
        // 两数组中的元素的总和
        int sum1 = 0;
        int sum2 = 0;
...
// 简化逻辑与代码, 只是小修改, 没有大变化
class ODInterview_II_2022_01_21_Solution {
    public String func(int[] nums1, int[] nums2) {
        // 两数组中的元素的总和
        int sum1 = 0;
        int sum2 = 0;
