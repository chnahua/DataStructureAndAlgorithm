package com.ahua.algorithm.prim;
...
class MinTree {
    ...
    public void prim(MGraph graph, int v) {
        //visited数组 标记结点(顶点)是否被访问过
        int[] visited = new int[graph.vertex];
        //visited数组 默认元素的值都是0, 表示没有访问过
...
//		}
        ...
        for(int k = 1; k < graph.vertex; k++) {//因为有 graph.vertex 个顶点，普利姆算法结束后，有 graph.vertex-1 条边
