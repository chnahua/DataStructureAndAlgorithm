...
|       算法       | 字符串 |             数组              |             （单向）链表             |  栈  | 队列 | 树（二叉树） |  图  |
| :--------------: | :----: | :---------------------------: | :----------------------------------: | :--: | :--: | :----------: | :--: |
|       递归       |        |                               |                                      |      |      |              |      |
|       回溯       |        |                               |                                      |      |      |              |      |
|     分治算法     |        |                               | <a href="#23-合并K个升序链表">23</a> |      |      |              |      |
|     动态规划     |        | <a href="#62-不同路径">62</a> |                                      |      |      |              |      |
|     贪心算法     |        |                               |                                      |      |      |              |      |
| 深度优先搜索 DFS |        |                               |                                      |      |      |              |      |
| 广度优先搜索 BFS |        |                               |                                      |      |      |              |      |
|    普里姆算法    |        |                               |                                      |      |      |              |      |
...
| 其它技巧 |                 字符串                  |                   数组                    |                             解释                             |
| :------- | :-------------------------------------: | :---------------------------------------: | :----------------------------------------------------------: |
| 数学公式 |                                         | <a href="#62-不同路径">62</a>（组合数学） | 有些题根据题意可以使用数学上的某些公式或现有定理直接计算得出答案 |
...
| [344. 反转字符串](https://leetcode-cn.com/problems/reverse-string/) |     数组      |  简单的数组操作   | 简单 |  2021.05.09  |  2021.10.31  |    2     | 是                 |             是             |               是               |               D                |              2021.10.31_超简单，以后可不再复习               |           <a href="#344-反转字符串">344</a>           |
