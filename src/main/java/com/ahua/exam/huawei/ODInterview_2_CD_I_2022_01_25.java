...
public class ODInterview_2_CD_I_2022_01_25 {
    public static void main(String[] args) {
        int[] nums = new int[]{1, 2, 3, 2, 3, 4};
        int[] nums1 = new int[]{4, 6, 7, 4, -1, -3, 4};
        int[] nums2 = new int[]{1, 2, 3, 4};
        ODInterview_2_CD_I_2022_01_25_Solution solution = new ODInterview_2_CD_I_2022_01_25_Solution();
...
class ODInterview_2_CD_I_2022_01_25_Solution1 {
...
// O(N^3)
class ODInterview_2_CD_I_2022_01_25_Solution2 {
    public int[] func(int[] nums) {
        int n = nums.length;
        // 前缀和数组
        int[] pre = new int[n + 1];
...
// O(N^2)
class ODInterview_2_CD_I_2022_01_25_Solution {
    public int[] func(int[] nums) {
        int n = nums.length;
        // 最终 firstIndex 为返回的第一个位置 i
        int firstIndex = -1;
