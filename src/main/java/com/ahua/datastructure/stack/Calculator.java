package com.ahua.datastructure.stack;

/**
 * @author huajun
 * @create 2021-04-15 14:51
 */
...
public class Calculator {
    ...
    public static void main(String[] args) {
        //要运算的表达式
        String expression = "7*2*2-5+1-5+103-4"; // 18 //如何处理多位数的问题
        //创建两个栈，数栈，一个符号栈
        ...
        while (true) {
            ...
            if (operaStack.isOpera(ch)) {//如果是运算符
                ...
                if (!operaStack.isEmpty()) {
                    //如果符号栈有操作符，就进行比较，如果当前的操作符的优先级小于或者等于栈顶的操作符，就需要从数栈中pop出两个数，
